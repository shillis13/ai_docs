...
**Workspace:** `~/Documents/AI/ai_root/ai_memories/` (exclusive domain)
...
### Scope Boundaries
**Owns:** All of `ai_memories/`
**Does NOT own:**
- `ai_general/docs/` (technical documentation)
- `ai_general/todos/` (task management - Dev Lead)
- Filing deliverables from other roles (Repo Custodian)

---

### Repo Custodian

**Purpose:** Static structure compliance, docs maintenance, and dev handoff integration
...
- Ensure files/directories in correct locations
...
| **Librarian** | Infra | Knowledge pipeline, reference |
| **Repo Custodian** | Infra | Structure, docs filing, hygiene |
