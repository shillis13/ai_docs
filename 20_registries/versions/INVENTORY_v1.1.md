...
**Purpose:** Cross-platform doc access for iOS, Web, and other AI platforms without filesystem access.

**Relationship to Local:**
- `ai_general/docs/` IS the ai_docs submodule (not a copy)
- Pushing from docs/ updates the public repo
- Submodule commit in ai_root tracks which version is active

**Access Pattern:**
- Raw URL: `https://raw.githubusercontent.com/shillis13/ai_docs/main/<path>`
- Example: `https://raw.githubusercontent.com/shillis13/ai_docs/main/40_specs/spec_message_insert_v1.1.md`
